...
var css =
  ".rolldate-container{font-family: SF Pro Display;font-size:2.3rem;color:#3C3C4399;text-align:center;}.rolldate-container ul{margin:0;padding:0;}.rolldate-container li{list-style-type:none;}.rolldate-container header{position:fixed;height:47rem;width:100%;top:0;line-height:2.8rem;font-size:2.3rem;}.rolldate-container .rolldate-mask{position:fixed;width:100%;height:100%;top:0;left:0;z-index:999;}.rolldate-container .rolldate-panel{position:fixed;bottom:0;left:0;width:100%;height:28.4rem;z-index:1000;background:transparent;-webkit-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out;-webkit-transform:translate3d(0,28.4rem,0);transform:translate3d(0,28.4rem,0)}.rolldate-container .rolldate-btn{position:absolute;left:0;top:0;height:100%;color:#666;font-size:16px;cursor:pointer;-webkit-tap-highlight-color:transparent}.rolldate-container .rolldate-confirm{position:fixed;top:-28.4rem;width:100%;left:0;right:0;color:#007bff}.rolldate-container .rolldate-content{position:relative;top:0;padding: 0 10.3rem;}.rolldate-container .rolldate-wrapper{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex}.rolldate-container .rolldate-wrapper>div{-webkit-box-flex:1;-webkit-flex:1;-ms-flex:1;flex:1;height:17.8rem;line-height:2.8rem;overflow:hidden;-webkit-flex-basis:-8e;-ms-flex-preferred-size:-8e;flex-basis:-8e;width:1%}.rolldate-container .rolldate-wrapper ul{margin-top:7.2rem}.rolldate-container .rolldate-wrapper li{text-align: center;height:3.4rem;}.rolldate-container .rolldate-dim{position:absolute;left:0;top:0;width:100%;height:7.2rem;background:-o-linear-gradient(bottom,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8));background:-webkit-gradient(linear, left bottom, left top, from(hsla(0, 0%, 100%, 0.4)), to(hsla(0, 0%, 100%, 0.8)));background:-o-linear-gradient(bottom, hsla(0, 0%, 100%, 0.4), hsla(0, 0%, 100%, 0.8));background:linear-gradient(0deg,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8));pointer-events:none;-webkit-transform:translateZ(0);transform:translateZ(0);z-index:10}.rolldate-container .mask-top{border:none}.rolldate-container .mask-bottom{top:auto;bottom:0;border:none}.rolldate-container .fadeIn{-webkit-transform:translateZ(0);transform:translateZ(0)}.rolldate-container .fadeOut{-webkit-transform:translate3d(0,28.4rem,0);transform:translate3d(0,28.4rem,0)}@media screen and (max-width:41.4rem){.rolldate-container{font-size:2.3rem}}@media screen and (max-width:32rem){.rolldate-container{font-size:2.3rem}}";
styleInject(css);
...
var bscroll_min = createCommonjsModule(function (module, exports) {
  ...
  !(function (t, i) {
    ...
    function h(t) {
      return (
        !1 !== r &&
        ("standard" === r ? ("transitionEnd" === t ? "transitionend" : t) : r + t.charAt(0).toUpperCase() + t.substr(1))
      );
    }
    function p(t, i, e, s) {
    ...
    return (
      ...
      (k.prototype._shouldNotRefresh = function () {
        var t =
          this.x > this.minScrollX || this.x < this.maxScrollX || this.y > this.minScrollY || this.y < this.maxScrollY;
                ...
                if (this.options.snap) {
                  ...
                  (this.currentPage = w),
                    (a =
                      ...
                      Math.max(Math.max(Math.min(Math.abs(i - w.x), 1e3), Math.min(Math.abs(e - w.y), 1e3)), 300)),
                    (i = w.x),
                    (e = w.y),
                    (this.directionX = 0),
                    (this.directionY = 0),
          ...
          !e || this.options.useTransition
            ? (this._transitionTimingFunction(s.style),
              ...
              e ||
                ...
                this.resetPosition(this.options.bounceTime, M.bounce) || this.trigger("scrollEnd", { x: t, y: i })),
              this.options.wheel &&
                (i > this.minScrollY
      ...
      (O.prototype._initWheel = function () {
        ...
        t.wheelWrapperClass || (t.wheelWrapperClass = "wheel-scroll"),
          ...
          void 0 === t.selectedIndex && ((t.selectedIndex = 0), I("wheel option selectedIndex is required!"));
      }),
  ...
  createUI: function createUI() {
    ...
    var _loop = function _loop(_i) {
      ...
      that.on("scrollEnd", function () {
        ...
        if (
          [domId["YYYY"], domId["MM"]].indexOf(that.wrapper.id) != -1 &&
          _this.scroll["YYYY"] &&
          _this.scroll["MM"] &&
          _this.scroll["DD"]
        ) {
          var _day = _this.getMonthlyDay(
